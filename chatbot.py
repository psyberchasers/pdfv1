...
openai_api_key = os.environ.get('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')
pinecone_api_key = os.environ.get('b7b715ef-f9c6-463c-8d8b-dd666f3bc212')
pinecone_environment = os.environ.get('us-west1-gcp-free')
pinecone_index = os.environ.get('pdf')
pinecone_namespace = 'pdftest'
temperature = 0.5
source_amount = 4

startup = f"""{Fore.WHITE}Using the following credentials:{Fore.WHITE}
OpenAI API Key: {Fore.RED}{'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'}{Fore.WHITE}
Pinecone API Key: {Fore.BLUE}{'b7b715ef-f9c6-463c-8d8b-dd666f3bc212'}{Fore.WHITE}
Pinecone Environment: {Fore.BLUE}{'us-west1-gcp-free'}{Fore.WHITE}
Pinecone Index: {Fore.BLUE}{'pdf'}{Fore.WHITE}
Pinecone Namespace: {Fore.GREEN}{'pdftest'}{Fore.WHITE}
